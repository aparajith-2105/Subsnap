...
let subscriptions: Subscription[] = [
  {
    ...
    predictedNextDate: "2026-07-02",
    category: "Entertainment",
    status: "active" as const,
    logoLetter: "N",
    billingDetails: "Monthly Stream • Entertainment",
    lastUsedDaysAgo: 2,
    logoUrl: "https://logo.clearbit.com/netflix.com",
    max_amount_per_charge: 25.00
  },
  {
    id: "dashlane-1",
    ...
    predictedNextDate: "2026-10-24",
    category: "Security",
    anomalyFlag: "Zero login activity detected in last 60 days (HMM Flag)",
    status: "active" as const,
    logoLetter: "D",
    billingDetails: "Annual Stream • Security",
    lastUsedDaysAgo: 60,
    logoUrl: "https://logo.clearbit.com/dashlane.com",
    max_amount_per_charge: 75.00
  },
  {
    id: "spotify-1",
    ...
    currency: "USD",
    frequency: "monthly" as const,
    predictedNextDate: "2026-07-29",
    category: "Audio",
    status: "active" as const,
    logoLetter: "S",
    billingDetails: "Monthly Stream • Audio",
    lastUsedDaysAgo: 4,
    logoUrl: "https://logo.clearbit.com/spotify.com",
    max_amount_per_charge: 15.00
  },
  {
    id: "adobe-1",
    ...
    currency: "USD",
    frequency: "monthly" as const,
    predictedNextDate: "2026-07-24",
    category: "Design",
    anomalyFlag: "Salient detection warning: Zero usage over last 30 days",
    status: "active" as const,
    logoLetter: "A",
    billingDetails: "Monthly Stream • Design",
    lastUsedDaysAgo: 22,
    logoUrl: "https://logo.clearbit.com/adobe.com",
    max_amount_per_charge: 100.00
  },
  {
    id: "trial-youtube",
    name: "YouTube Premium Free Trial",
    amount: 0.00,
    nextTransitionAmount: 14.99,
    currency: "USD",
    frequency: "monthly" as const,
    ...
    status: "active" as const,
    logoLetter: "Y",
    billingDetails: "7-Day Free Trial • Transitions to Paid ($14.99/mo)",
    lastUsedDaysAgo: 1,
  ...
  },
  {
    ...
    name: "Apple TV+ Trial",
    amount: 0.00,
    nextTransitionAmount: 9.99,
    currency: "USD",
    frequency: "monthly" as const,
    predictedNextDate: "2026-07-03",
    category: "Entertainment",
    status: "active" as const,
    logoLetter: "A",
    billingDetails: "30-Day Free Trial • Transitions to Paid ($9.99/mo)",
    lastUsedDaysAgo: 0,
...
let logs: AuditLog[] = [
  {
    id: "log-1",
    timestamp: "2026-06-30 14:02:11",
    action: "FTC_RULE_VERIFY",
    details: "All cancel paths verified compliant with FTC 2026 Rule",
    status: "COMPLIANT" as const,
  },
  {
    id: "log-2",
    timestamp: "2026-06-30 15:15:30",
    action: "HMM_ANOMALY_DETECT",
    details: "Dashlane Family flagged as inactive (HMM model id: 77X1)",
...
let notifications: SystemNotification[] = [
  {
    ...
    title: "Upcoming Charge Risk Identified",
    message: "Netflix Premium ($19.99) will be debited on July 2, 2026. Review consent now.",
  ...
  },
  {
    id: "notif-2",
    type: "anomaly",
    title: "Zero Usage Alert (Dashlane)",
    message: "Zero activity over the last 60 days on Dashlane Family ($59.99/yr).",
    timestamp: "2026-06-30 15:15:30",
    read: false,
    severity: "high",
    subId: "dashlane-1",
  },
  {
    id: "notif-3",
    type: "anomaly",
    title: "Zero Usage Alert (Adobe CC)",
    message: "Zero activity over the last 30 days on Adobe Creative Cloud ($89.99/mo).",
